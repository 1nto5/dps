  ...
  const services = [
    {
      ...
      description: 'Całodobowa opieka pielęgniarska i psychiatryczna. Podawanie leków, monitorowanie stanu zdrowia.',
    },
    {
      icon: (
        <svg className="w-10 h-10" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      title: 'Rehabilitacja',
      description: 'Indywidualne programy rehabilitacyjne. Ćwiczenia fizyczne, masaże, fizykoterapia.',
    },
    {
      icon: (
        <svg className="w-10 h-10" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      title: 'Wyżywienie',
      description: 'Pełne wyżywienie dostosowane do potrzeb dietetycznych. Świeże, domowe posiłki przygotowywane na miejscu.',
    },
    {
      icon: (
        <svg className="w-10 h-10" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      description: 'Warsztaty artystyczne, muzykoterapia, zajęcia manualne. Aktywizacja i rozwijanie zainteresowań mieszkańców.',
    },
    {
      icon: (
        <svg className="w-10 h-10" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      description: 'Przestronne, jasne pokoje jedno- i dwuosobowe. Wyposażone w łazienki, TV i dostęp do internetu.',
    },
    {
      icon: (
        <svg className="w-10 h-10" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      description: 'Wykwalifikowani terapeuci wspierają mieszkańców. Integracja ze środowiskiem lokalnym.',
    },
  ]
